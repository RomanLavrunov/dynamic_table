        ...
        <div className='table-container' ref={mainContainerRef}>
            <div className='sticky-header'>
                <nav className='nav-bar'>
                    ...
                    <Link className='nav-link' href={'/server'} locale="en">EN</Link>
                    <Link className='nav-link' href={'/server'} locale="ru">RU</Link>
                    <Link className='nav-link' href={'/server'} locale="et">ET</Link>
                </nav>
